...
**How to know what DOES work.** The test tiers, not this page. `scripts/run-suites.sh hermetic` (65 runs /
6032 assertions) and `service` (45 / 1583) are the standing answer, and they fail on a skip, so a green run
