...
public sealed class AggregateSession : IAggregateSession
{
        ...
        switch (src)
        {
            ...
            default:
                throw new NotSupportedException(
                    $"arrownet: custom aggregate argument type {src.Data.DataType} is not supported");
        }
    }
    ...
    private static IArrowArray BuildResultColumn(IArrowType type, IReadOnlyList<object?> values)
    {
        ...
        switch (type)
        {
            ...
            default:
                throw new NotSupportedException($"arrownet: custom aggregate result type {type} is not supported");
        }
    }
}
