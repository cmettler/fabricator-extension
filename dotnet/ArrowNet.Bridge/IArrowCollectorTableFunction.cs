...
/// the streaming <see cref="IArrowInOutFunction"/> instead.
/// </summary>
...
/// <see cref="IArrowInOutFunction"/>. <see cref="Bind"/> resolves the per-call binding from the constant
...
/// <summary>
/// Adapts an <see cref="IArrowCollectorBinding"/> to <see cref="IArrowInOutBinding"/> so a collector flows
...
/// </summary>
public sealed class CollectorInOutBinding : IArrowInOutBinding
{
    private readonly IArrowCollectorBinding _inner;

    public CollectorInOutBinding(IArrowCollectorBinding inner) => _inner = inner;
