...
internal sealed class NativeParquetDataFileRewriter : IDataFileRewriter
{
    ...
    private const string PosColumn = "__arrownet_pos";
    private const string UpdInput = "__arrownet_upd";
    private const string ExclInput = "__arrownet_excl";
    ...
    /// <c>[__arrownet_pos:int64 ++ &lt;set columns, in setColumns order&gt;]</c> of the rows to update in that file.</summary>
    internal NativeParquetDataFileRewriter(string tablePath, Schema userSchema,
