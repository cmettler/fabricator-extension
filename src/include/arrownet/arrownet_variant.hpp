//===----------------------------------------------------------------------===//
// arrownet — VARIANT over the Arrow C boundary
//
...
// RegisterArrowNetVariantExtension registers the `arrownet.variant` extension so VARIANT crosses EVERY
...
void RegisterArrowNetVariantExtension(duckdb::DatabaseInstance &db);
